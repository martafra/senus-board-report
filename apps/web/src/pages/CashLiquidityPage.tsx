...
import { EbitdaToFcfBridge } from '@/components/EbitdaToFcfBridge'
...
const COLUMNS: MetricColumn[] = [
  ...
  { key: 'operating_cash_adjustments', label: 'Working Capital & Other' },
  { key: 'cash_investing', label: 'Investing Cash Flow' },
            ...
            <>
              <div className="grid gap-6 md:grid-cols-2">
                <div className="h-64 rounded-lg border bg-background p-4">
                  <p className="mb-2 text-xs text-muted-foreground">Free Cash Flow trend.</p>
                ...
                <EbitdaToFcfBridge periods={periods} color={ACCENT} />
              </div>
